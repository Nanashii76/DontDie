...
public class Player3 extends Player {
	...
	public Player3(int x, int y, int width, int height, BufferedImage sprite) {
		...
		for (int i = 0; i < rightPlayer.length; i++ ) {
			rightPlayer[i] = Game.spritesheet.getSprite(64+(i*32), 193, 32, 32);
		}
		for (int i = 0; i < leftPlayer.length; i++ ) {
			leftPlayer[i] = Game.spritesheet.getSprite(64+(i*32), 225, 32, 32);
		}
		for (int i = 0; i < idlePlayer.length; i++ ) {
			idlePlayer[i] = Game.spritesheet.getSprite(64+(i*32), 256, 32, 32);
		}
